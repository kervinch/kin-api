CREATE TYPE order_details_status_enum AS ENUM ('awaiting_payment', 'paid', 'pending', 'processing', 'delivery', 'completed', 'refund_requested', 'refund_rejected', 'refund_completed');
