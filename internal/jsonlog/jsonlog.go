...
func (l *Logger) print(level Level, message string, properties map[string]string) (int, error) {
	...
	// Marshal the anonymous struct to JSON and store it in the line variable. If there was a problem creating the JSON, set the contents of the log entry to be that plain-text error message instead.
